...
function message($msg, $redirect = '', $type = '') {
	...
	if($redirect == '') {
		$type = in_array($type, array('success', 'error', 'question', 'attention', 'tips', 'ajax', 'sql')) ? $type : 'error';
	} else {
		$type = in_array($type, array('success', 'error', 'question', 'attention', 'tips', 'ajax', 'sql')) ? $type : 'success';
	}
	...
	if (strexists($_SERVER['HTTP_USER_AGENT'], 'MicroMessenger')) {
